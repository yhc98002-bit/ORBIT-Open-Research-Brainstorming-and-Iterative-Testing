...
G11 IF PLAN_CODE_AUDIT.md verdict = CRITICAL_MISMATCH
    ...
    audit until the cause is fixed or explicitly judged by a human. Codex unavailability
    follows codex-precondition.md: LOUD STOP, STATE awaiting_user_action, and no substitute
    audit verdict.
