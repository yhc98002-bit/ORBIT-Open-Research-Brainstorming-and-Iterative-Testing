...
/proposal-revise "refine-logs/FINAL_PROPOSAL.md" \
  — critiques: "ALGORITHM_TOURNAMENT 选了 S2 但 S5 falsifiability 更强；
                假设 A2 关于 iid 数据不成立，我们有时间相关性"
```
`/proposal-revise` 接受用户具体不满意点，按拥有该决策的 v1.3 stage 自动归类，只重跑受影响
...
- `skills/proposal-revise/SKILL.md` — STOP A 修订环：用户 critique 驱动针对性修改
