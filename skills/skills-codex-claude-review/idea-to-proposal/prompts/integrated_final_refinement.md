...
Claude CLI reviewer switches to **collaborator calibration** before STOP A. The goal is a clean
...
If Claude CLI reviewer flags a serious problem with the winner sketch, the integrated proposal MAY pick
