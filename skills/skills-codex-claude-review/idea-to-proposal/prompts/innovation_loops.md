...
`../shared-references/innovation-loops.md` §7.1). Claude CLI reviewer appends candidates / blind spots /
...
collaborative additions" section after Claude CLI reviewer returns.
...
new constraint*. Claude CLI collaborative additions append more analogies.
...
Claude CLI reviewer on sketch quality is collaborative; on tournament adjudication Claude CLI reviewer switches to
...
ABSTAIN_REASONS: <if Claude CLI reviewer objected>
