...
`direct Claude CLI prompt/raw-JSON files`, write it under
`.aris/review-prompts/<phase-id>.md`, and require the user to save the standalone
Codex response to `.aris/review-outputs/<phase-id>.response.md` before importing
