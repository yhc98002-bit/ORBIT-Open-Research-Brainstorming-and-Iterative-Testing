...
- **MAX_STRESS_TEST_ROUNDS = 1** — One Claude CLI reviewer critique round.
...
### Phase 6: Claude CLI reviewer Stress Test
...
6. Use Claude CLI reviewer reply for continuity if useful
