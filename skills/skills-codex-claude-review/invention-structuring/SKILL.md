...
- `REVIEWER_MODEL = claude-cli` — External reviewer for invention decomposition validation
...
- If `claude -p` is not available, skip cross-model validation and note it in the output.
